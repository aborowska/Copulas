...
A1=log(gamma((nu+d)/2))-log(gamma(nu/2))-0.5*log((pi*nu)^d)-0.5*log(1-rho.^2);
A2=(-(nu+d)/2)*log(1+X/nu);
A3=log(gamma((nu+1)/2))-log(gamma(nu/2))-0.5*log(pi*nu)-((nu+1)/2)*log(1+(y(1,:).^2)/nu);
A4=log(gamma((nu+1)/2))-log(gamma(nu/2))-0.5*log(pi*nu)-((nu+1)/2)*log(1+(y(2,:).^2)/nu);
